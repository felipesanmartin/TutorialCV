...
class ColorPixels:
    ...
    def pixels(self, color_space="rgb"):
        ...
        if color_space == "hsv":
            image = cv2.cvtColor(self._image, cv2.COLOR_RGB2HSV)
...
class Hist3D:
    ...
    def __init__(self, image,
                 num_bins=16, alpha=0.1, color_space='rgb', num_pixels=1000):
        self._computeTargetPixels(image, color_space, num_pixels)
    ...
    def _computeTargetPixels(self, image, color_space, num_pixels):
